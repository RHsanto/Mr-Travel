            ...
            <div className="col-lg-4">
              <div className="single-info shadow">
                <div className="info-icons">
                  ...
                  <p className="re-icons">
                    <b>ROOM DETAILS</b>
                  </p>
                  <li>
                    <b>Check in :</b> Friday, May 27, 2022
                  </li>
                  <li>
                    <b>Check out :</b> Saturday, May 28, 2022
                  </li>
                  <li>
                    <b>Room(s) : {offer?.room}</b>{" "}
                  </li>
                  <li>
                    <b>Guest(s) per room : {offer?.guest}</b>{" "}
                  </li>
                </div>
